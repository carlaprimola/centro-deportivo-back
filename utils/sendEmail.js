...
export const emailNewPlayerNotification = async (player, user) => {
  const mailOptions = {
    ...
    subject: '¡Nueva solicitud de Nuevo Jugador ⚽!, recuerda verificarlo en tu dashboard.',
    html: `
      <div style="font-family: Arial, sans-serif; padding: 20px;">
        ...
        <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
          ...
          <tr>
            <td style="padding: 10px; border: 1px solid #ddd;">Apellidos del Jugador</td>
            <td style="padding: 10px; border: 1px solid #ddd;">${player.lastname}</td>
          </tr>
          <tr>
            <td style="padding: 10px; border: 1px solid #ddd;">Fecha de Nacimiento</td>
          ...
          <tr>
            <td style="padding: 10px; border: 1px solid #ddd;">DNI del Padre/Responsable</td>
          ...
          <tr>
            <td style="padding: 10px; border: 1px solid #ddd;">Email del Padre/Responsable</td>
